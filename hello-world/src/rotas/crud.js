...
//     const query = 'SELECT id, username, fullname, cpf, phonenumber, address, dateofbirth FROM usuarios';
//     connection.query(query, (err, results) => {
//         if (err) {
//             console.error(err);
//             return res.status(500).send('Erro ao buscar usuários');
//         }
//         res.render('usuarios', { usuarios: results });  // Renderiza a página com a lista de usuários
//     });
// };
